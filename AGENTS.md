...
Run `typecheck`, not bare `tsc --noEmit`: route types such as `LayoutProps<"/">`
are generated by Next into `.next/types` and do not exist until `next typegen`
(or a build) has written them.
